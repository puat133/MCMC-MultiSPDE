...
@nb.vectorize(signatures=[nb.complex128(nb.int64,nb.float64)],cache=CACHE,nopython=True)
...
@nb.vectorize(signatures=[nb.float64(nb.float64)],cache=CACHE,nopython=True)
def kappaFun(ut):
    """
